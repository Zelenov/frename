//! File name display component. Shows the generated file name for the current file.
//!
//! Display-only; no messages. Lives in the file workspace above the tag panel.
...
pub fn view<'a>(file: Option<&'a File>) -> Element<'a, crate::features::tag_panel::Message> {

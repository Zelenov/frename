---
name: trait-generics
description: Master Rust traits, generics, and type system. Use when defining traits, generic functions/structs, trait objects, associated types, or operator overloading.
---

---
name: error-handling
description: Master Rust's Result, Option, and error handling patterns. Use when implementing error types, propagation with ?, or choosing between thiserror and anyhow.
---
